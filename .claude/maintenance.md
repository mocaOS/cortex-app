...
The handbook contains 26 chapters (`01-introduction.md` through `26-self-hosting.md`) covering features end-to-end from a user perspective. When adding or changing user-facing features, update the relevant handbook chapter(s):
