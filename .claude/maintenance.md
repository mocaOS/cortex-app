...
The handbook contains 27 chapters (`01-introduction.md` through `27-cortex-trainings.md`) covering features end-to-end from a user perspective. When adding or changing user-facing features, update the relevant handbook chapter(s):
