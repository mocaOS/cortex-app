...
- **🛡️ Prompt Security**: Layered prompt-injection defense — a query-time ML classifier (**Prompt Guard** / PIGuard), 25+ pattern detectors, untrusted-content fencing, output filtering, and an ingestion-time scan. See the [Security guide](documentation/pages/guides/security.mdx).
