...
[Cortex Registry](https://github.com/mocaOS/cortex-registry) — a git-native,
PR-moderated catalog of apps. Open **Settings → Apps → Browse Registry** to
see what's available, with each app's declared key scope, endpoint allowlist,
and platform capabilities visible before you commit to anything.
