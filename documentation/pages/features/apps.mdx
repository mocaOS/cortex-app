...
This page covers apps hosted *inside* your instance. The ecosystem also includes **standalone apps** — full applications with their own deployment and users that connect via the REST API with scoped keys: [Cortex Chat](/features/cortex-chat) (the flagship multi-tenant chat frontend), [Cortex Trainings](/features/cortex-trainings) (interactive training courses as single offline HTML files) and [Cortex Videogen](/features/cortex-videogen) (marketing videos from your knowledge base).
