...
# EXTRACTION_MAX_OUTPUT_TOKENS=0        # 0 = inherit OPENAI_MAX_OUTPUT_TOKENS (=8000); recommended explicit 12000 — ≈ half the extraction input budget (entity-dense docs overflow smaller caps)
