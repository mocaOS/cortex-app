...
Skills work in both **Deep Research** and **Chat** modes. To use skills in Chat, enable agentic chat mode by setting `ENABLE_AGENT_CHAT=true`.
...
| `ENABLE_AGENT_CHAT` | `false` | Enable agentic chat mode (required for skills in Chat) |
