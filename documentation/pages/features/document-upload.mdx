...
| EPUB | `.epub` | E-books parsed natively — much faster than the same book as PDF; prefer uploading the EPUB when you have both. Kindle formats (`.mobi`, `.azw`) are not supported — convert them to EPUB first (e.g. with Calibre) |
