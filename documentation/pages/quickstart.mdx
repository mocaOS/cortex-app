...
RELATIONSHIP_MAX_CONTEXT=256000     # relationship batching keeps a wide read window (bounded output per call)
...
RELATIONSHIP_MAX_CONTEXT=256000              # wide read window is safe (bounded output per call); 0 = inherit extraction → primary
