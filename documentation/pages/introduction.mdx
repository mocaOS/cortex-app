...
- **Per-topic skills:** `https://cortexskills.org/<topic>/SKILL.md` — e.g. `/upload`, `/search`, `/ask`, `/graph`, `/collections`, `/auth`, `/setup`, `/admin`, `/tasks`, `/git-integration`, `/web-import`, `/mcp`, `/integration`, `/hermes`, `/openclaw`
