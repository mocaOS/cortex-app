---
title: Introduction
description: Welcome to the MOCA Library documentation - an agentic knowledge base powered by AI and GraphRAG
---
...
**MOCA Library** is an **agentic knowledge base** that transforms your documents into a searchable, AI-powered knowledge graph. Upload documents, ask questions, and get intelligent answers with full source citations.

Built with **FastAPI**, **Haystack 2.0**, **Neo4j**, and **Next.js**, MOCA combines the power of large language models with graph-based retrieval for superior question answering.
...
| **Ask AI** | RAG-powered Q&A with streaming, agentic reasoning, and source citations |
...
MOCA exposes **60+ REST API endpoints** across these categories:
...
| Knowledge Graph | 6 | Entities, relationships, subgraphs, visualization |
...
- [GitHub](https://github.com/mocaOS/library) - Source code and issues
