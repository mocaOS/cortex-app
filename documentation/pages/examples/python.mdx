...
class MOCAClient:
    ...
    def upload_document(
        ...
        with open(path, 'rb') as f:
            ...
            data = {'start_processing': str(start_processing).lower()}
            if collection_id:
    ...
    def ask(
        ...
        Args:
            ...
            turbo_mode: Use Compute3 GPU acceleration
        """
        ...
        return self._request('POST', '/api/rag', json=payload)
    ...
    def ask_streaming(
        ...
        response = self.session.post(
            f"{self.base_url}/api/rag/stream",
            json=payload,
            stream=True
        )
        response.raise_for_status()
