...
# Increase if your relationship/extraction model supports a larger context window
...
| `RELATIONSHIP_MAX_CONTEXT` | No | `65536` | Max INPUT context window tokens for relationship analysis batching. Must match `RELATIONSHIP_EXTRACTION_MODEL` context window |
