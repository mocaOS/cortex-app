...
# RESEARCHER_MAX_ITERATIONS_QUALITY=8    # Deep research mode (quality)
...
# RESEARCHER_WALL_CLOCK_SECONDS=120      # Research time budget; on expiry the writer starts (0 = unlimited)
```
