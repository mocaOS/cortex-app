...
# Max context window tokens for relationship analysis output
...
| `RELATIONSHIP_ANALYSIS_BATCH_SIZE` | No | `100` | Max entities per relationship analysis call |
| `RELATIONSHIP_MAX_CONTEXT` | No | `65536` | Max context window tokens for relationship analysis |
