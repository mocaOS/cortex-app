...
| `EXTRACTION_MAX_OUTPUT_TOKENS` | No | `0` (=inherit) | Output budget for entity extraction. Inherits `OPENAI_MAX_OUTPUT_TOKENS`. Recommended explicit `12000` — ≈ half of `GRAPH_EXTRACTION_MAX_CONTEXT` |
