...
**Concurrency defaults.** The shipped defaults (`BATCH_PROCESSING_CONCURRENCY=3`, `CONCURRENT_EXTRACTIONS=3`, `CONCURRENT_RELATIONS=3`, `VISION_MAX_CONCURRENT=3`) are the recommended, reliably-tested setting — leave them as-is unless you have a specific reason to change them.
