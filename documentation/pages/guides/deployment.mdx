---
title: Deployment
description: Deploy MOCA Library to production with Docker and Coolify
---

This guide covers deploying MOCA Library to production environments using Docker Compose and Coolify.
...
export ADMIN_API_KEY=moca_admin_your-key
...
MOCA includes Coolify-ready configuration for easy deployment.
...
2. **Configure Git Repository**
   - Repository: `https://github.com/mocaOS/library`
   - Branch: `main`
...
3. **Set Environment Variables**
   ...
   ADMIN_API_KEY=moca_admin_your-secure-key
   SESSION_SECRET=your-32-character-secret
   ```

4. **Configure Domains**
   - Frontend: `moca.yourdomain.com`
   - Backend API: `api.moca.yourdomain.com`
...
http {
    ...
    server {
        listen 80;
        server_name moca.yourdomain.com;
    ...
    server {
        listen 443 ssl http2;
        server_name api.moca.yourdomain.com;
