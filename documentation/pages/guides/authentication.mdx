...
description: Secure your MOCA Library API with API key authentication
---

MOCA Library uses API key authentication to secure endpoints. This guide covers how authentication works and how to manage API keys.

## Overview

MOCA has two authentication layers:
