...
GRAPH_EXTRACTION_MAX_CONTEXT=16000         # batch-size/graph-density dial — validated zero-truncation with the terse prompt
EXTRACTION_MAX_OUTPUT_TOKENS=16000         # generous ceiling matched to the context (not a ½-ratio)
# RELATIONSHIP_MAX_CONTEXT stays unset — inherits 16000. See its table entry before widening.
