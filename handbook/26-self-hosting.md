...
10. **Collects your admin identity and secrets** — Cortex and Chat share one identity when chat is installed (see [Logging in](#logging-in)) — generating all five secrets automatically unless you choose to set them yourself.
